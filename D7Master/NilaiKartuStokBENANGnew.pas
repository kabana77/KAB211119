...
type
  TNilaiKartuStokBENANGnewFrm = class(TForm)
    Panel1: TPanel;
...
var
  NilaiKartuStokBENANGnewFrm: TNilaiKartuStokBENANGnewFrm;
...
procedure TNilaiKartuStokBENANGnewFrm.FormClose(Sender: TObject;
...
procedure TNilaiKartuStokBENANGnewFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNilaiKartuStokBENANGnewFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TNilaiKartuStokBENANGnewFrm.TabSheet2Show(Sender: TObject);
var
   v1, v2, v3, v4 : REAL;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNilaiKartuStokBENANGnewFrm.ECariChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNilaiKartuStokBENANGnewFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  x : Integer;
...
procedure TNilaiKartuStokBENANGnewFrm.FormShow(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBENANGnewFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TNilaiKartuStokBENANGnewFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNilaiKartuStokBENANGnewFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TNilaiKartuStokBENANGnewFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNilaiKartuStokBENANGnewFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.RadioGroup1Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNilaiKartuStokBENANGnewFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNilaiKartuStokBENANGnewFrm.BtnExportClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
  0 : begin
       if QBrowse.Active then
...
procedure TNilaiKartuStokBENANGnewFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNilaiKartuStokBENANGnewFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.BitBtn2Click(Sender: TObject);
var
  vmybulan : string;
  i : Integer;
  w1, w2, w3, w4, w5, w6, w7, w8 : REAL;
...
procedure TNilaiKartuStokBENANGnewFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QBrowseCalcFields(DataSet: TDataSet);
var
  v1, v2 : real;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.BitBtn3Click(Sender: TObject);
var
  i : integer;
begin
 { i:=0;
...
procedure TNilaiKartuStokBENANGnewFrm.BitBtn4Click(Sender: TObject);
begin
{  try
  QUpdateMutasi.Close;
...
procedure TNilaiKartuStokBENANGnewFrm.BitBtn6Click(Sender: TObject);
begin
{  QTutupTransaksi.Open;
...
procedure TNilaiKartuStokBENANGnewFrm.Label7Click(Sender: TObject);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QNilaiAwalBeforeOpen(DataSet: TDataSet);
begin
  QNilaiAwal.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBENANGnewFrm.QNilaiMasukBeforeOpen(DataSet: TDataSet);
begin
  QNilaiMasuk.SetVariable('pkd_jns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid2DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TNilaiKartuStokBENANGnewFrm.QRiwayatTransaksiCalcFields(
  DataSet: TDataSet);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.cbStokClick(Sender: TObject);
begin
  QBrowse.Filtered:=cbStok.Checked;
end;

procedure TNilaiKartuStokBENANGnewFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QTutupTransaksiBeforeOpen(
  DataSet: TDataSet);
begin
  QTutupTransaksi.SetVariable('pjns_item',vkd_jns_item);
end;

procedure TNilaiKartuStokBENANGnewFrm.TabSheet3Show(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QRBand3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 QRLabel20.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TNilaiKartuStokBENANGnewFrm.wwDBGrid4URLOpen(Sender: TObject;
  var URLLink: String; Field: TField; var UseDefault: Boolean);
begin
 Detail.Show;
end;

procedure TNilaiKartuStokBENANGnewFrm.DetailShow(Sender: TObject);
var
 i : integer;
 R1, R2 : real;
begin
...
procedure TNilaiKartuStokBENANGnewFrm.QRBand15BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  QRLabel49.Caption:='Periode : '+DateToStr(VTglAwal.Date)+' s/d '+DateToStr(vTglAkhir.Date);
end;

procedure TNilaiKartuStokBENANGnewFrm.QRBand10BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
{  QRLTitle.Caption:=LTitle.Caption;
  QRLPeriode.Caption:=VTglAwal.Text+' s/d '+vTglAkhir.Text;}
...
procedure TNilaiKartuStokBENANGnewFrm.QRBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
